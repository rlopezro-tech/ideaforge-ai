...
import { Clipboard, Lightbulb, Loader2, LogIn, RefreshCw, Sparkles } from "lucide-react";
...
export default function Product() {
  ...
  return (
    <>
      <Head>
        <title>IdeaForge AI | Product</title>
      </Head>
        ...
        <SignedOut>
          <section className="mx-auto flex min-h-screen w-full max-w-4xl flex-col items-center justify-center px-5 py-12 text-center">
            ...
            <p className="mt-4 max-w-xl text-base font-medium leading-7 text-ink/64 md:text-lg">
              Accede al generador para crear oportunidades SaaS con IA y validar nuevos conceptos.
            </p>
